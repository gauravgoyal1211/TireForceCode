...
- (void)viewDidLoad {
    ...
    if(val==5)
    {
        [_LabelTitle setText:@"Quote Only (all tires in the market)"];
    ...
    {
        [_LabelTitle setText:@"Quote Only (tires from my suppliers) "];
    ...
    {
        [_LabelTitle setText:@"Live Pricing (tires from my suppliers)"];
    ...
    {
        [_LabelTitle setText:@"Ecommerce (not available yet)"];
